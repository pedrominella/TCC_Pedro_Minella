# -*- coding: utf-8 -*-
"""
petroleo_lp_modelo7.py

MODELO 7 - LOCAL PROJECTIONS DO TCC
...
- Petrobras em 2 regimes: pré-outubro/2016 e pós-outubro/2016.
...
OUTPUT_DIR = Path("output_petroleo_lp_modelo7")
...
def carregar_preparar_base_ipca():
    ...
    # Modelo 7: corte institucional Petrobras em outubro de 2016.
    # Pré: jan/2003 a set/2016.
    # Pós: out/2016 em diante.
    ...
    df.to_excel(OUTPUT_TABELAS / "base_modelo7_transformada.xlsx", index=False)
...
def gerar_graficos_regimes(tabela):
    ...
    for chaves, sub in tabela.groupby(grupos, dropna=False):
        ...
        nota = (
            "Regimes: pré-outubro/2016 e pós-outubro/2016. "
...
def executar_modelo7():
    print("\n" + "=" * 100)
    print("MODELO 7 - LOCAL PROJECTIONS | CORTE PETROBRAS EM OUTUBRO DE 2016")
    ...
    print("\n" + "=" * 100)
    print("4) REGIMES PETROBRAS EM DOIS PERÍODOS")
    print("=" * 100)
    ...
    tabela_regimes = salvar_resultados(resultados_regimes, "resultados_lp_regimes_petrobras_out2016")
    tabela_wald = salvar_resultados(resultados_wald, "testes_wald_regimes_petrobras_out2016")
    ...
    relatorio = []
    relatorio.append("RELATÓRIO DO MODELO 7\n")
    relatorio.append("=====================\n\n")
    relatorio.append("O Modelo 7 segue o padrão de leitura do Modelo 5, com CONFIG_COLUNAS explícito.\n")
    ...
    relatorio.append("Regimes Petrobras, corte out/2016: pré-outubro/2016 e pós-outubro/2016.\n")
    ...
    relatorio.append("Gráficos: salvos em output_petroleo_lp_modelo7/graficos.\n\n")
