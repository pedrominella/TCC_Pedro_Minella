...
OUTDIR = Path("output_tcc_var_selic_ativ_espec_Modelo7_stringency")
...
plot_series(work["Stringency"].dropna(), "Stringency - nível mensal", OUTDIR / "graficos" / "01_nivel" / "Stringency_nivel.png")
...
# Exógenas: dummies sazonais + índice de stringency
exog = pd.concat([
